...
from auth.models import Usuario, UsuarioRolCampo
from auth.schemas import RefreshResponse, ResetPasswordConfirm, TokenResponse
...
from core.hashing import hash_password, needs_rehash, verify_password
from security.schemas import UserContext
from security.token_service import create_access_token, create_refresh_token, decode_token
...
async def _notify_reset_token(email: str, token: str) -> None:
    ...
    Cuando el equipo defina el contrato, reemplazar este stub
    por una llamada HTTP al Notification Service:
    ...
    Por ahora loguea el token para desarrollo local.
    """
